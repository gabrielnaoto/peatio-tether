RSpec.describe Peatio::Tether::Wallet do
  let(:wallet) { Peatio::Tether::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Tether::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Tether::Wallet::SUPPORTED_SETTINGS))
    end
  end
